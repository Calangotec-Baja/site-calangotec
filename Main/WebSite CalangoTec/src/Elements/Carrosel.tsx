...
export default function CarroselGenerico() {
    ...
    useEffect(() => {
        const cardsExemplo = [
            ...
            { id: "2", titulo: "POWERTRAIN", descricao: "Adicionar descrição", imagem: pwtCard, link: "/manutencao/2", icone: "/icone2.svg" },
            { id: "3", titulo: "ESTRUTURA", descricao: "Adicionar descrição", imagem: estrutCard, link: "/eficiencia/3", icone: "/icone3.svg" },
            { id: "4", titulo: "SUSPENSÃO", descricao: "Adicionar descrição.", imagem: suspCard, link: "/eletronica/4", icone: "/icone4.svg" },
            ...
            { id: "6", titulo: "FREIOS", descricao: "Adicionar descrição.", imagem: freioCard, link: "/inovacao/6", icone: "/icone6.svg" },
        ];
